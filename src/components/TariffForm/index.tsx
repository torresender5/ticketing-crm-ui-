...
import TariffFormProfile from './TariffFormProfile'
...
const TariffProfile = ({ fareIdParam, readOnly }: FareProfileProps) => {
    // tabs
    ...
    const tabsOption = [
        {
            ...
            caption: 'datos para gestionar tarifas',
            disabled: false,
        },
        // {
        //     label: 'Usuarios',
