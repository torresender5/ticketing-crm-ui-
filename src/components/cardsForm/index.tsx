...
const tabsOption = [
    {
        label: 'Creación de Tipos de Tarjetas',
        icon: <PersonOutlineTwoToneIcon />,
        caption: 'Datos asociados a la tarjeta',
    },
    // {
    //     label: 'Usuarios',
...
const CardsProfile = ({ cardsIdParam, readOnly }: CompanyProfileProps) => {
